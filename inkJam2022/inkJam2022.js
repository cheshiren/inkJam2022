		...
		[{
			...
			"Start": [
				["^He enters the room with the quick “Morning” and occupies the chair on the other side of the table.", "\n", "^Then he opens his case, takes out some papers and skims through them. Nods to himself a couple of times and turns to me.", "\n", "^“So. Do you understand the reason of your presence here?” ", {
					...
					"g-0": ["ev", "str", "^Everything in my report", "/str", "/ev", {
						"*": ".^.c-2",
						"flg": 20
					}, "ev", "str", "^Circumstances were unusual, indeed", "/str", "/ev", {
						"*": ".^.c-3",
						"flg": 20
					}, {
					...
					"g-1": ["^“Right. That is exactly why I am here. I would like to ask you a several questions regarding your report. Maybe you will remember some new details or would look on things in different perspective, like that.” ", {
						"#": "CLASS: interrogator"
					}, "\n", ["ev", "str", "^Shrug", "/str", "/ev", {
						"*": ".^.c-4",
						"flg": 20
					}, "ev", "str", "^Do I have a choice?", "/str", "/ev", {
						"*": ".^.c-5",
						"flg": 20
					}, {
						"c-4": ["\n", "^I just shrug.", "\n", {
					...
					"g-3": ["^“Fine,” he looks in his papers, “So, what was the initial reason of the operation?” ", {
						"#": "CLASS: interrogator"
					}, "\n", "ev", "str", "^Emergency call", "/str", "/ev", {
						"*": ".^.c-6",
						"flg": 20
					}, "ev", "str", "^Missing person reports", "/str", "/ev", {
						"*": ".^.c-7",
						"flg": 20
					}, {
					...
					"g-4": ["<>", "^ Some suicide cult or something. She told that there were several dozens of people forcibly kept there: men, women, young, old, children. Told that she has managed to escape the village before ‘Final day has come’.”", "\n", "^“What was the plan of action? Was it of local or federal authorities?” ", {
						"#": "CLASS: interrogator"
					}, "\n", "ev", "str", "^Local", "/str", "/ev", {
						"*": ".^.c-8",
						"flg": 20
					}, "ev", "str", "^Federal", "/str", "/ev", {
						"*": ".^.c-9",
						"flg": 20
					}, {
					...
					"g-5": ["<>", "^ Two our groups had to fly heli to the neighbouring wheatfields forty or so kilometers off the place. Then we had to cover the distance on foot to arrive the village in quiet. And then act accordingly to the situation on the ground.”", "\n", "^“What was the size of those groups?” ", {
						"#": "CLASS: interrogator"
					}, "\n", ["ev", "str", "^Main group", "/str", "/ev", {
						"*": ".^.c-10",
						"flg": 20
					}, "ev", "str", "^My group", "/str", "/ev", {
						"*": ".^.c-11",
						"flg": 20
					}, {
						"*": ".^.c-12",
					...
					"g-6": ["^“At what time did you arrived in the fields? How long did it take to approach the village?” ", {
						"#": "CLASS: interrogator"
					}, "\n", "ev", "str", "^Morning", "/str", "/ev", {
						"*": ".^.c-13",
						"flg": 20
					}, "ev", "str", "^Noon", "/str", "/ev", {
						"*": ".^.c-14",
					...
					"g-7": ["<>", "^  We’ve descended on the closest available spot, then went through the woods as quiet as hunting rangers. After four hours we’ve reached our destination.”", "\n", "^“Have you succeed in your ambush?” ", {
						"#": "CLASS: interrogator"
					}, "\n", ["ev", "str", "^You’re perfectly aware what was there", "/str", "/ev", {
						"*": ".^.c-15",
						"flg": 20
					}, "ev", "str", "^There wasn’t need in an ambush", "/str", "/ev", {
						"*": ".^.c-16",
						"flg": 20
					}, {
						"c-15": ["\n", "^“You’ve read my report. What is the purpose in such question? You’re perfectly aware what was there.”", "\n", "^“Yes, indeed. But as I said, it is crucial for you to recall every possible detail. So?” ", {
							"#": "CLASS: interrogator"
						}, "\n", {
							"->": ".^.^"
						}, {
					...
					"g-8": ["^“We’ll be back on this topic in a moment. For now, would you describe the village, please? How many houses there were, their condition etc.” ", {
						"#": "CLASS: interrogator"
					}, "\n", ["ev", "str", "^Number", "/str", "/ev", {
						"*": ".^.c-17",
						"flg": 20
					}, "ev", "str", "^Condition", "/str", "/ev", {
						"*": ".^.c-18",
						"flg": 20
					}, {
						"*": ".^.c-19",
					...
					"g-9": ["^“Could you elaborate on this middle area? What it was like?” ", {
						"#": "CLASS: interrogator"
					}, "\n", "ev", "str", "^Common space", "/str", "/ev", {
						"*": ".^.c-20",
						"flg": 20
					}, "ev", "str", "^Center of the village", "/str", "/ev", {
						"*": ".^.c-21",
						"flg": 20
					}, {
					...
					"g-10": ["<>", "^ The spot was surrounded by idols.”", "\n", ["^“And the idols? What they were like? Were they numerous?” ", {
						"#": "CLASS: interrogator"
					}, "\n", ["ev", "str", "^Description", "/str", "/ev", {
						"*": ".^.c-22",
						"flg": 20
					}, "ev", "str", "^Amount", "/str", "/ev", {
						"*": ".^.c-23",
						"flg": 20
					}, {
						"*": ".^.c-24",
						...
						"c-24": ["\n", "^“Ok. Returning to the villagers. Where did you find them? What was the state of the bodies? How many of them were there?” ", {
							"#": "CLASS: interrogator"
						}, "\n", {
							"->": "Start.0.bodies"
						}, {
					...
					"bodies": ["ev", "str", "^Where", "/str", "/ev", {
						"*": ".^.c-25",
						"flg": 20
					}, "ev", "str", "^How many", "/str", "/ev", {
						"*": ".^.c-26",
						"flg": 20
					}, {
						"*": ".^.c-27",
						...
						"c-26": ["\n", "^“Exactly thirty eight corpses heaped in the spot.”", "\n", "^“Did you checked the surroundings? No bodies in other places?” ", {
							"#": "CLASS: interrogator"
						}, "\n", ["ev", "str", "^Of course", "/str", "/ev", {
							"*": ".^.c-0",
							"flg": 20
						}, {
					...
					"g-12": ["^“What was the next step after finding the bodies?” ", {
						...
						"c-28": ["\n", "^“We had to secure the village, first. We’ve checked all the buildings in and out, scanned the surrounding forests with the heat-seeking equipment. There were nobody and nothing.”", "\n", ["ev", "str", "^Then we had to inform the HQ", "/str", "/ev", {
							...
							"g-0": ["^“Have you mentioned the idols to the HQ?” ", {
								"#": "CLASS: interrogator"
							}, "\n", "ev", "str", "^Yes", "/str", "/ev", {
								"*": ".^.c-1",
								"flg": 20
						...
						"c-29": ["\n", "^“We had to inform the HQ on the situation, first. The commander radioed our status and got the further instructions: check the surrounding area, then one group stays in the village, waiting for the forensics, the other traverse to the nearby hill for an evac.”", "\n", "^“Have you mentioned the idols to the HQ?” ", {
							...
							"g-0": ["ev", "str", "^Then we checked the area", "/str", "/ev", {
								"*": ".^.c-2",
								"flg": 20
							}, {
					...
					"g-13": ["^“Who were staying in the village?” ", {
						"#": "CLASS: interrogator"
					}, "\n", "ev", "str", "^It had to be my group", "/str", "/ev", {
						"*": ".^.c-30",
						"flg": 20
					}, "ev", "str", "^Commander’s group", "/str", "/ev", {
						"*": ".^.c-31",
						"flg": 20
					}, {
					...
					"g-14": ["<>", "^ Me and my men went to the landing zone.”", "\n", ["^“At what time did you arrive in LZ?” ", {
						"#": "CLASS: interrogator"
					}, "\n", "ev", "str", "^Around five o’clock in the evening", "/str", {
						"CNT?": ".^.^.^.g-6.c-13"
					}, "/ev", {
						"*": ".^.c-32",
						"flg": 21
					}, "ev", "str", "^Around six o’clock in the evening", "/str", {
						"CNT?": ".^.^.^.g-6.c-13"
					}, "/ev", {
						"*": ".^.c-33",
						"flg": 21
					}, "ev", "str", "^Around nine o’clock in the night", "/str", {
						"CNT?": ".^.^.^.g-6.c-14"
					}, "/ev", {
						"*": ".^.c-34",
						"flg": 21
					}, "ev", "str", "^Around ten o’clock in the night", "/str", {
						"CNT?": ".^.^.^.g-6.c-14"
					}, "/ev", {
						"*": ".^.c-35",
						"flg": 21
					...
					"g-16": ["<>", "^ Then we radioed to commander and HQ about our arrival and waited for the helis.”", "\n", ["^“How long did you have to wait and what did you do in the meantime?” ", {
						"#": "CLASS: interrogator"
					}, "\n", ["ev", "str", "^How long", "/str", "/ev", {
						"*": ".^.c-36",
						"flg": 20
					}, "ev", "str", "^Occupation", "/str", "/ev", {
						"*": ".^.c-37",
						"flg": 20
					}, {
						"*": ".^.c-38",
						...
						"c-36": ["\n", "^“", "<>", "\n", "ev", {
							"CNT?": "Start.0.g-14.g-15.c-32.1.lz_5"
						}, "/ev", [{
							"->": ".^.b",
							"c": true
						}, {
							"b": ["^On timing: we’ve waited for too long. Spent all the evening on that goddamn hill and still never caught with any helis.", {
								"->": ".^.^.^.8"
							}, null]
						}], "nop", "\n", "ev", {
							"CNT?": "Start.0.g-14.g-15.c-33.1.lz_6"
						}, "/ev", [{
							"->": ".^.b",
							"c": true
						}, {
							"b": ["^On timing: we’ve waited for long. Spent several hours on that goddamn hill and still never caught with any helis.", {
								"->": ".^.^.^.14"
							}, null]
						}], "nop", "\n", "ev", {
							"CNT?": "Start.0.g-14.g-15.c-34.1.lz_9"
						}, "/ev", [{
							"->": ".^.b",
							"c": true
						}, {
							"b": ["^On timing: we’ve waited for a couple of hours on the hill. Never caught with any helis though.", {
								"->": ".^.^.^.20"
							}, null]
						}], "nop", "\n", "ev", {
							"CNT?": "Start.0.g-14.g-15.c-35.1.lz_10"
						}, "/ev", [{
							"->": ".^.b",
							"c": true
						}, {
							"b": ["^On timing: we’ve moved out from the village rather late, so we hadn’t much time to spend on that hill. Never caught with any helis though.", {
								"->": ".^.^.^.26"
							}, null]
						}], "nop", "\n", "<>", "^”", "\n", {
							"->": ".^.^"
						...
						"c-37": ["\n", "^“Meanwhile, we’ve ", "ev", {
							"CNT?": "Start.0.g-13.c-30"
						}, "/ev", [{
							"->": ".^.b",
							"c": true
						}, {
							"b": ["^cared the arm of our radioman and ", {
								"->": ".^.^.^.6"
							}, null]
						}], "nop", "^tried to get some sleep.”", "\n", {
							"->": ".^.^"
						}, {
							"->": "Start.0.g-18"
						}, {
					...
					"g-18": ["^“What has interrupted your evac?” ", {
						"#": "CLASS: interrogator"
					}, "\n", "ev", "str", "^We got a distress call from the village", "/str", "/ev", {
						"*": ".^.c-39",
						"flg": 20
					}, "ev", "str", "^We heard some gunshots from the village", "/str", "/ev", {
						"*": ".^.c-40",
						"flg": 20
					}, {
					...
					"g-19": ["<>", "^ When I’ve asked who they were fighting, the commander answered, ‘You must see with your own eyes, Ildar. Incredible, yet those bastards have risen from the dead. Like in a freaking movie.’”", "\n", "^“Is that what he said?” ", {
						"#": "CLASS: interrogator"
					}, "\n", "ev", "str", "^Yeah", "/str", "/ev", {
						"*": ".^.c-41",
						"flg": 20
					...
					"g-20": ["^“What did you do next?” ", {
						"#": "CLASS: interrogator"
					}, "\n", "ev", "str", "^We’ve rushed to help", "/str", "/ev", {
						"*": ".^.c-42",
						"flg": 20
					}, "ev", "str", "^We’ve informed the HQ", "/str", "/ev", {
						"*": ".^.c-43",
						"flg": 20
					}, {
						"c-42": ["\n", "^“We’ve rushed to help our comrades, of course.", "ev", {
							"CNT?": ".^.^.^.g-13.c-30"
						}, "/ev", [{
							"->": ".^.b",
							"c": true
						}, {
							"b": ["^ Only radioman left on the hill for he wouldn’t be much help in a fight because of his injury.", {
								"->": ".^.^.^.6"
							}, null]
						}], "nop", "^”", "\n", "^“Have you informed the HQ?” ", {
							"#": "CLASS: interrogator"
						}, "\n", ["ev", "str", "^Yes", "/str", "/ev", {
							"*": ".^.c-0",
							"flg": 20
							...
							"c-0": ["\n", "ev", 1, "/ev", {
									...
									"b": ["^Yes, I’ve instructed radioman to report to HQ", {
										"->": ".^.^.^.11"
									}, null]
								}],
								[{
									...
									"b": ["^Yes, we’ve reported", {
										"->": ".^.^.^.11"
									}, null]
								}], "nop", "^ that the group in the village needed our help and we were going back. But without details on any of this voodoo crap.”", "\n", {
									"->": "Start.0.g-21"
								}, {
									"#f": 5
								}
							...
							"c-1": ["\n", "^“", "ev", {
									...
									"b": ["^No, I forbade radioman to report any of this voodoo crap before we got clearer picture", {
										"->": ".^.^.^.7"
									}, null]
								}],
								[{
									...
									"b": ["^No, there were no time for reports", {
										"->": ".^.^.^.7"
									}, null]
								}], "nop", "^.”", "\n", {
									"->": "Start.0.g-21"
						...
						"c-43": ["\n", "ev", 1, "/ev", {
							"VAR=": "Attack_was_reported",
							"re": true
						}, "^“First of all we’ve contacted the HQ and reported that the group in the village needed our help and we were going back. But without details on any voodoo crap. They said that they would send reinforcement and that we should try to handle it on our own until their arrival. Then we ", "ev", {
							"CNT?": ".^.^.^.g-13.c-30"
						}, "/ev", [{
							"->": ".^.b",
							"c": true
						}, {
							"b": ["^left our injured radioman on the hill and ", {
								"->": ".^.^.^.10"
							}, null]
						}], "nop", "^run to the village.”", "\n", {
							"->": ".^.^.^.g-21"
						}, {
							"#f": 5
						}]
					}],
					"g-21": ["^“How fast did you reach the village? Did you enter it the same way as before?” ", {
						"#": "CLASS: interrogator"
					}, "\n", "ev", "str", "^We were fast", "/str", "/ev", {
						"*": ".^.c-44",
						"flg": 20
					}, "ev", "str", "^We were quiet", "/str", "/ev", {
						"*": ".^.c-45",
						"flg": 20
					}, {
					...
					"g-22": ["^“Did you see the attackers?” ", {
						"#": "CLASS: interrogator"
					}, "\n", "ev", "str", "^How couldn’t we?", "/str", "/ev", {
						"*": ".^.c-46",
						"flg": 20
					}, {
					...
					"g-23": ["^“Ok, sure. Let’s discuss this in a little more detail. In your report, you used the word ‘Infernal’ describing the attackers. Could you explain why you chose such a strong wording?” ", {
						"#": "CLASS: interrogator"
					}, "\n", "ev", "str", "^Do you have any smokes for me?", "/str", "/ev", {
						"*": ".^.c-47",
						"flg": 20
					}, "ev", "str", "^What is your name?", "/str", "/ev", {
						"*": ".^.c-48",
						"flg": 20
					}, {
						"c-47": ["\n", "^“Do you have any smokes for me?”", "\n", "^He nods, opens his case, pulls out a started pack of “Shuangxi” — red and golden paper — and places it between us on the table. Then sets a transparent lighter next to the pack. I take a cigarette in my mouth, light its end and inhale deeply. Then start coughing.", "\n", ["ev", "str", "^I quit smoking a long time ago", "/str", "/ev", {
							"*": ".^.c-0",
							"flg": 20
						}, "ev", "str", "^Chinese smokes are the worst", "/str", "/ev", {
							"*": ".^.c-1",
							"flg": 20
						}, {
							...
							"g-0": ["^He smirks, nods again and pulls a cigarette too.", "\n", {
								"->": "Start.0.g-24"
							}, null]
						}], {
							"#f": 5
						...
						"c-48": ["\n", "^“You haven’t introduced yourself when you’ve entered. What is your name?”", "\n", "^He pauses examining my expression.", "\n", "^“It’s Darius.” ", {
							"#": "CLASS: interrogator"
						}, "\n", ["ev", "str", "^Almost namesake", "/str", "/ev", {
							"*": ".^.c-0",
							"flg": 20
						}, "ev", "str", "^Like an ancient king", "/str", "/ev", {
							"*": ".^.c-1",
							"flg": 20
						}, {
							...
							"c-1": ["\n", "^“Ah, like an ancient Persian king.”", "\n", "^“There were several of them. But we are diverting.” ", {
								"#": "CLASS: interrogator"
							}, "\n", {
								"->": "Start.0.g-24"
							}, {
					...
					"g-24": ["^“You wanted to elaborate on ‘Infernal’ description of the attackers.” ", {
						"#": "CLASS: interrogator"
					}, "\n", "ev", {
						"CNT?": ".^.^.g-23.c-47"
					}, "/ev", [{
						...
						"b": ["^I blow out a puff of smoke and continue talking.", {
							"->": ".^.^.^.7"
						}, null]
					}], "nop", "\n", ["ev", "str", "^How they looked", "/str", "/ev", {
						"*": ".^.c-49",
						"flg": 20
					}, "ev", "str", "^How they moved", "/str", "/ev", {
						"*": ".^.c-50",
						"flg": 20
					}, "ev", "str", "^How they sounded", "/str", "/ev", {
						"*": ".^.c-51",
						"flg": 20
					}, "ev", "str", "^How they smelled", "/str", "/ev", {
						"*": ".^.c-52",
						"flg": 20
					}, "ev", "str", "^How they reacted to shots", "/str", "/ev", {
						"*": ".^.c-53",
						"flg": 20
					}, {
						"*": ".^.c-54",
						...
						"c-53": ["\n", "^“We stormed the village trying to reach the warehouse and fired at every ", "ev", {
								"CNT?": ".^.^.c-51"
							}, "/ev", [{
								"->": ".^.b",
								"c": true
					...
					"g-25": ["^“When you get into the warehouse, how many people were still alive there?” ", {
						"#": "CLASS: interrogator"
					}, "\n", "ev", "str", "^Not many", "/str", "/ev", {
						"*": ".^.c-55",
						"flg": 20
					}, "ev", "str", "^Enough to kick any asses", "/str", "/ev", {
						"*": ".^.c-56",
						"flg": 20
					}, {
						"c-55": ["\n", {
					...
					"g-26": ["^“Of the main team there were two of them, including the commander. Plus, ", "ev", {
							"CNT?": ".^.^.g-13.c-30"
						}, "/ev", [{
							"->": ".^.b",
							"c": true
						...
						}], "nop", "^ of my team came to help — we’ve lost two brave men to some sneaking bastards on our way. Overall, it was ", "ev", {
							"CNT?": ".^.^.g-13.c-30"
						}, "/ev", [{
							"->": ".^.b",
							"c": true
						...
						[{
							...
							"b": ["^Not overwhelmingly many, if compared to the horde outside", {
								"->": ".^.^.^.19"
							}, null]
						}], "nop", "ev", {
							"CNT?": ".^.^.g-25.c-56"
							...
							"b": ["^More that enough to kick any amount of asses", {
								"->": ".^.^.^.24"
							}, null]
						}], "nop", "^.”", "\n", "^“Then you have asked your superior how the attack started, right?” ", {
							"#": "CLASS: interrogator"
						}, "\n", "ev", "str", "^Yes", "/str", "/ev", {
							"*": ".^.c-57",
							"flg": 20
					...
					"g-27": ["^“What did he say?” ", {
						"#": "CLASS: interrogator"
					}, "\n", "ev", "str", "^Idols were singing", "/str", "/ev", {
						"*": ".^.c-59",
						"flg": 20
					}, {
					...
					"g-28": ["^“The idols were singing? Is that what he said?” ", {
						"#": "CLASS: interrogator"
					}, "\n", "ev", "str", "^Should I repeat?", "/str", "/ev", {
						"*": ".^.c-60",
						"flg": 20
					}, "ev", "str", "^I tell you what I was told", "/str", "/ev", {
						"*": ".^.c-61",
						"flg": 20
					}, {
						"c-60": ["\n", "^“Should I repeat one more time", "ev", {
							"CNT?": ".^.^.^.g-23.c-48"
						}, "/ev", [{
							"->": ".^.b",
							"c": true
						...
						}], "nop", "^I tell you what I was told, ok?", "\n", {
							"->": ".^.^.^.g-29"
						}, {
							"#f": 5
						}]
					}],
					"g-29": ["<>", "^ Yes, he said that the idols started to sing first and then all hell broke loose. When they’ve managed to barricade themselves inside the warehouse, they’ve lost three men.”", "\n", ["^“Ok, that’s clear. Next to the resolution — how did you find out the way idols influenced the attackers?” ", {
						"#": "CLASS: interrogator"
					}, "\n", "ev", "str", "^By accident", "/str", "/ev", {
						"*": ".^.c-62",
						"flg": 20
					}, "ev", "str", "^Out of rage", "/str", "/ev", {
						"*": ".^.c-63",
						"flg": 20
					}, {
					...
					"g-31": ["<>", "^. Then, suddenly, the whole pack of cadavers in front of it just fell on the ground. We realised that bullets destroyed idol’s eyes. That was our salvation.”", "\n", ["^“And what next? You just destroyed all the idols?” ", {
						"#": "CLASS: interrogator"
					}, "\n", "ev", "str", "^That wasn’t that easy", "/str", "/ev", {
						"*": ".^.c-64",
						"flg": 20
					}, "ev", "str", "^Pretty much, yeah", "/str", "/ev", {
						"*": ".^.c-65",
						"flg": 20
					}, {
					...
					"g-33": ["<>", "^. The last standing was at the central ring of idols, surrounding the sacrifice spot. At this time villagers gave up trying to get us and were covering the idols with their own bodies,” ", "ev", {
							"CNT?": ".^.^.g-23.c-47"
						}, "/ev", [{
							"->": ".^.b",
							"c": true
						}, {
							"b": ["^I take a last drag from the cigarette and stump it", {
								"->": ".^.^.^.7"
							}, null]
						}],
						[{
							...
							"b": ["^I take a pause remembering the details", {
								"->": ".^.^.^.7"
							}, null]
						}], "nop", "^, “When I were shooting at the last idol it was screaming.”", "\n", ["^“Screaming?” ", {
							"#": "CLASS: interrogator"
						}, "\n", "ev", "str", "^Howling", "/str", "/ev", {
							"*": ".^.c-66",
							"flg": 20
						}, "ev", "str", "^Wailing", "/str", "/ev", {
							"*": ".^.c-67",
							"flg": 20
						}, "ev", "str", "^Weeping", "/str", "/ev", {
							"*": ".^.c-68",
							"flg": 20
						}, {
					...
					"g-35": ["<>", "^. Screaming. Is it clear", "ev", {
					...
					}], "nop", "^?", "\n", ["^“Yes, I understand. How many of you left at the moment? What did you do next?” ", {
						"#": "CLASS: interrogator"
					}, "\n", ["ev", "str", "^Who’s left", "/str", "/ev", {
						"*": ".^.c-69",
						"flg": 20
					}, "ev", "str", "^What did I do", "/str", "/ev", {
						"*": ".^.c-70",
						"flg": 20
					}, {
						"*": ".^.c-71",
						...
						"c-69": ["\n", "^“It was just me in the end. Everybody else fell before the last shootout or succumbed to their wounds soon after.”", "\n", "ev", {
								...
								"b": ["^“What about the man in the LZ?”", {
									"->": ".^.^.^.8"
								}, null]
							}],
							[{
								...
								"c-0": ["\n", "^“You tell me. I’ve been here for five days and don’t know anything. Have you found him?”", "\n", "^“We haven’t yet. Didn’t you tried to find him?” ", {
									...
									"b": ["^“As I said, I don’t remember anything…”", {
										"->": ".^.^.^.10"
									}, null]
								}], "nop", "\n", {
									"->": ".^.^.g-0"
					...
					"next_step": ["^He nods, checks something in his papers.", "\n", "^“Well, we almost finished here. I have only a couple of questions. First is just formality: say, did you use any drugs, stimulants or psychotropics before, in time of, or immediately after the operation?” ", {
						"#": "CLASS: interrogator"
					}, "\n", "ev", "str", "^The cigarette", "/str", {
						"CNT?": ".^.^.g-23.c-47"
					}, "/ev", {
						"*": ".^.c-72",
						"flg": 21
					}, "ev", "str", "^No, but I’d wish to", "/str", {
						"CNT?": ".^.^.g-23.c-47"
					}, "!", "/ev", {
						"*": ".^.c-73",
						"flg": 21
					}, "ev", "str", "^Check my medical tests", "/str", "/ev", {
						"*": ".^.c-74",
						"flg": 20
					}, {
					...
					"g-37": ["^“Checked. And the last question. Actually, the most important one of all our talks.” ", {
						"#": "CLASS: interrogator"
					}, "\n", "^He looks into my eyes.", "\n", "^“Ildar, regarding all this data you’ve collected and things you’ve experienced: what if I offered you to join a certain government agency that investigates these kinds of… incidents?” ", {
						"#": "CLASS: interrogator"
					}, "\n", "^“Would you join the Office ‘T’?” ", {
						"#": "CLASS: interrogator"
					}, "\n", "ev", "str", "^Yes", "/str", "/ev", {
						"*": ".^.c-75",
						"flg": 20
					...
					"g-38": ["ev", "str", "^The End", "/str", "/ev", {
						...
						"c-77": ["\n", "ev", {
							...
							"b": ["^Payment wasn’t bad at all, true. But was it worth it?", {
								"->": ".^.^.^.5"
							}, null]
						}], "nop", "\n", "ev", {
							"CNT?": ".^.^.^.g-37.c-76"
							...
							"b": ["^They executed me in the following month. I guess, it was against the rules: to know that much and not to be involved.", {
								"->": ".^.^.^.11"
							}, null]
						}], "nop", "\n", "end", {
							"#f": 5
